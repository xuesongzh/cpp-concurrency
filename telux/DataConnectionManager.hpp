 ...
 *
 */
using DataCallListResponseCb =
    std::function<void(const std::vector<std::shared_ptr<IDataCall>> &dataCallList, telux::common::ErrorCode error)>;
...
class IDataConnectionManager {
 public:
     ...
     *
     */
    virtual telux::common::Status startDataCall(int profileId, IpFamilyType ipFamilyType = IpFamilyType::IPV4V6,
     ...
     *
     */
    virtual telux::common::Status stopDataCall(int profileId, IpFamilyType ipFamilyType = IpFamilyType::IPV4V6,
                                               DataCallResponseCb callback = nullptr,
                                               OperationType operationType = OperationType::DATA_LOCAL,
                                               std::string apn = "") = 0;
    /**
